...
\begin{figure}[H]
\centering
\includegraphics[width=1.0\textwidth]{../Hardware Notes/PCB Design/pcb-schematic-rev4.pdf}
\caption{Wiring Diagram for PCB Components}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=1.0\textwidth]{../Hardware Notes/PCB Design/layout.png}
\caption{PCB Layout Using Commercial Components}
\end{figure}
