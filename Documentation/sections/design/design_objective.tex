...
Notifications will be sent to everyone in the associated group when the water level drops below the threshold. This allows all users to be aware of the water level and give everyone the opportunity to refill it when it is empty, making it more likely that it will be refilled. 