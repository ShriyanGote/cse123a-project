...
\noindent Demo\\
\url{https://git.ucsc.edu/pnauwela/123a-project/-/blob/main/Documentation/Demo-Script.pdf?ref_type=heads}\\
\noindent Design Schematic\\
\url{https://git.ucsc.edu/pnauwela/123a-project/-/blob/main/Documentation/Diagrams/Architecture_Diagram.pdf?ref_type=heads}\\
